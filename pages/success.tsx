...
const Success = ({ products}: Props) => {
    ...
    const subtotal = products.reduce((acc, product) => 
        acc + product.price.unit_amount/100, 0
    )
            ...
            <main className='grid grid-cols-1 lg:grid-cols-9'>
                <section className='order-2 mx-auto max-w-xl pb-12 lg:col-span-5 lg:mx-0 lg:max-w-none lg:pr-16 lg:pt-16 xl:pl-16 2xl:pl-44'>
                    ...
                    <div className='my-8 ml-4 flex space-x-4 lg:ml-14 xl:ml-0'>
                        <div className='flex w-11 h-11 items-center justify-center rounded-full border-2 border-black'> 
                    ...
                    <div className='orderDetails divide-y divide-gray-300'>
                        <div className='space-y-2 pb-3'>
                            <p>Your order is confirmed.</p>
                            <p className='text-sm text-gray-600'>We've accepted your order, and we are getting it ready. Come 
                                back to this page for updates on your shipment status.</p>
                        </div>
                    ...
                    <div className='orderDetails my-4'>
                        <p>Order updates</p>
                ...
                { mounted && (
                    ...
                    lg:col-span-4 lg:h-screen lg:border-y-0'>
                        ...
                        { showOrderSummaryCondition && (
                            <div className='mx-auto mx-w-xl divide-y border-gray-300 px-4 py-4 lg:mx-0
                            lg:mx-w-lg lg:px-10 lg:py-16'>
